...
- 사용법
    ```
        ...
        [{'1번째 얼굴': [{'임계값': 23.56, '두 얼굴의 유사도': 18.85, '일치 여부': True},
            {'임계값': 23.56, '두 얼굴의 유사도': 73.93, '일치 여부': False} ]},
        {'2번째 얼굴': [{'임계값': 0.3, '두 얼굴의 유사도': 0.21, '일치 여부': True},
            {'임계값': 0.3, '두 얼굴의 유사도': 0.81, '일치 여부': False} ]}]
